...
locals {
  policy_definitions = concat(
    ...
    [
      {
        name = "[Preview]: Virtual Machines should be Zone Aligned"
      ...
      {
        name = "[Preview]: Storage Accounts should be Zone Redundant"
      ...
      {
        name = "[Preview]: Backup and Site Recovery should be Zone Redundant"
      ...
      {
        name = "[Preview]: Load Balancers should be Zone Resilient"
      ...
      {
        name = "[Preview]: Public IP addresses should be Zone Resilient"
      ...
      {
        name = "[Preview]: Virtual network gateways should be Zone Redundant"
...
output "Resilience_initiative" {
  value = {
    ...
    metadata = {
      ...
      description = "Initiative for CCHOP-Resilience (WARA) resources, including custom and built-in policies."
    }
  }
}