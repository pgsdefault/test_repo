...
locals {
  custom_policy_files = fileset("${path.module}/../../policyDefinitions/CHOP-Diagnostics-Settings-CUS", "*.json")
  policy_parameters   = jsondecode(file("${path.module}/../../parameters/CHOP-Diagnostics-Settings-CUS.json"))
  ...
  custom_policy_group_mapping = {
    ...
    file => lookup(
      jsondecode(file("${path.module}/../../policyDefinitions/CHOP-Diagnostics-Settings-CUS/${file}")).metadata,
...
module "custom_policy" {
  ...
  policy_json_path    = "${path.module}/../../policyDefinitions/CHOP-Diagnostics-Settings-CUS/${each.key}"
...
locals {
  policy_definitions = concat(
    ...
    [
      ...
      { name = "recoveryvault-logging-to-la"
      ...
      { name = "automationaccount-logging-to-la"
...
output "Diagnostics_cus_initiative" {
  value = {
    name                     = "CHOP-Diagnostics-Settings-cus-initiative"
    display_name             = "CHOP-EPIC-Diagnostics Settings Initiative-CentralUS"
