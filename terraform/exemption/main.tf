# ==================== EXEMPTION MAIN CONFIGURATION ====================
# This file references the exemption module
# Symlinks to: ../../policy_exemption.tf

# Import exemption module from parent directory
# terraform init -backend-config="key=exemption.tfstate"

# The actual module "policy_exemption" block from policy_exemption.tf should be included here
# This will be executed in the exemption directory context
